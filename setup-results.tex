...
case with background traffic. For Huffpost, we observed similar behavior for no background and with background traffic cases in all the three scenarios. 
...
\begin{center}
\includegraphics[trim= 3cm 3.25cm 3cm 3cm, clip=true, width=.98\linewidth]{plots/MPTCP-Web}
\end{center}
