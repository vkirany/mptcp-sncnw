...
There is substantial improvement in the download time in 3G-3G scenario. 
In the asymmetric scenario (WLAN-3G) the performance of MPTCP is not significantly lower than that of the TCP as
