...
\begin{abstract}
Multipath TCP (MPTCP) is a proposed extension of TCP that provides network resilience
by utilizing the available redundant resources. 
In this paper, we evaluate the impact of Multipath TCP on web traffic transport latency. We measure the latency of short lived flows 
